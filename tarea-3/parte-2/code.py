...
def Interconectado():
    ...
    net.addLink( s1, s2 )
    net.addLink( s2, s3, params1={'use_htb':True}, params2={'use_htb':False})
    net.addLink( s3, s4, params1={'use_htb':True}, params2={'use_htb':False})
    net.addLink( s4, s1, params1={'use_htb':True}, params2={'use_htb':False})
